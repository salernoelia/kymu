    ...
    Tables: {
      ...
      exercises: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "public_training_block_exercises_default_exercise_id_fkey";
          ...
          {
            foreignKeyName:
              "public_training_block_exercises_training_unit_id_fkey";
      ...
      exercises_default_templates: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "public_exercises_default_templates_default_exercise_id_fkey";
            columns: ["default_exercise_id"];
            isOneToOne: false;
            referencedRelation: "default_exercises";
            referencedColumns: ["id"];
      ...
      unit_default_templates: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "public_training_blocks_therapist_templates_therapist_uid_fkey";
            columns: ["therapist_uid"];
            isOneToOne: false;
            referencedRelation: "therapists";
            referencedColumns: ["uid"];
