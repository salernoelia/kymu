...
export const useEditorStore = defineStore("editor", () => {
    ...
    async function duplicateExercise(exerciseId: string) {
        try {
            ...
            // Remove id and created_at as these will be generated by the database
            ...
            if (data && data[0]) {
                ...
                // Find the unit containing this exercise
                const unit = units.value.find((u) => {
                    return u.exercises?.some((e) => e.id === exerciseId);
                });
            ...
            toast({
                ...
                description: "The exercise has been duplicated successfully.",
                variant: "default",
            });
        } catch (err) {
