...
export class VideoPlayer {
   ...
   * @param {boolean} lockMouse use checked propety for lock mouse
   * @param {HTMLVideoElement} videoElement
   * @param {HTMLImageElement} fullScreenButtonElement
   */
  createPlayer(
    playerElement,
    lockMouse,
    ...
    this.lockMouseCheck = lockMouse;
    this.videoElement = videoElement;
    this.fullScreenButtonElement = fullScreenButtonElement;
  ...
  _onFullscreenChange() {
    if (document.webkitFullscreenElement || document.fullscreenElement) {
      ...
      if (this.lockMouseCheck) {
        ...
        document.addEventListener(
          "click",
          this._mouseClickFullScreen.bind(this),
          false
        );
      }
    } else {
   ...
   * @param {HTMLVideoElement} videoElement
   */
  setupInput(channel, videoElement) {
