<template>
  <UCard class="max-w-sm w-full ">
    ...
    <div class="flex justify-center items-center pt-4 w-full">
      <nuxt-link @click="logIn"
        class="w-full bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded cursor-pointer">Login</nuxt-link>
    </div>
    ...
    <div class="mt-4 text-center">
      ...
      <NuxtLink :to="localePath('/signup')" class="text-gray-500 hover:text-black hover:underline cursor-pointer">
        {{ $t('signup') }}
      </NuxtLink>
    </div>
